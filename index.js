...
`;
        sendButImage(from, menu, "by @herman Chanel ❤️", thumb, [
          {
...
case 'donat':
  ...
  ├─ ❏ 083146208804
  ├─ ❏ *INSTAGRAM*
  └─ ❏ https://www.instagram.com/@cal_me_herman`)
...
• ${prefix}fitnah
• ${prefix}fitnahpc
• ${prefix}kontak 6283146208804|herman
• ${prefix}jadian
• ${prefix}
• ${prefix}tod
• ${prefix}truth
